# federation-transport Specification

## Purpose

Provide the secure transport layer for federation: HTTP Signature signing and verification, SSRF
protections on remote fetches, idempotent inbox processing, queued and retried outbound delivery, and
an allowlist that is disabled by default.
