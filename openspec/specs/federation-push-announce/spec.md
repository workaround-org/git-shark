# federation-push-announce Specification

## Purpose

Emit a ForgeFed `Push` activity when commits are received on a public, federated repository, append
it to the repository outbox, and deliver it to followers.
